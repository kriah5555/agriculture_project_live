...
urlpatterns = [
    ...
    path('auto-link-devise/<str:uid>/',             v.auto_link_devise,                 name="auto-link-devise"),
    ...
    path('api-overview/<int:pk>/recommendation-text/', v.api_recommendation_text,       name="api-recommendation-text"),
    path('api-overview/<int:pk>/tab-croprec/',      v.api_tab_croprec,                  name="api-tab-croprec"),
    ...
    path('link-ph-bottle/<int:pk>/',                v.link_ph_bottle_to_reading,        name="link-ph-bottle-to-reading"),
    path('unlink-ph-bottle/<int:pk>/',              v.unlink_ph_bottle_from_reading,    name="unlink-ph-bottle-from-reading"),
    path('link-soil-lens/<int:pk>/',                v.link_soil_lens_to_ph_bottle,      name="link-soil-lens-to-ph-bottle"),
    path('unlink-soil-lens/<int:pk>/',              v.unlink_soil_lens_from_ph_bottle,  name="unlink-soil-lens-from-ph-bottle"),
    ...
    path('delete-user-request/<int:pk>/',           v.delete_user_request,              name='delete-user-request'),
    path('delete-contact-notification/<int:pk>/',   v.delete_contact_notification,      name='delete-contact-notification'),
    path('delete-api-call/<int:pk>/',               v.delete_api_call,                  name='delete-api-call'),
    path('api-reading/<int:pk>/upload-image/',      v.api_reading_upload_image,         name='api-reading-upload-image'),
    path('api-reading/<int:pk>/delete-image/',      v.api_reading_delete_image,         name='api-reading-delete-image'),
    ...
    path('farmer/<int:pk>/device-readings/<int:device_id>/', v.farmer_device_readings,           name='farmer-device-readings'),
