...
urlpatterns = [
    ...
    path('change-password-request/', login_required(v.change_password_request), name='change-password-request'),
    path('resolve-user-request/<int:pk>/', login_required(v.resolve_user_request), name='resolve-user-request'),
