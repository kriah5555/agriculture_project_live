...
admin.site.register(models.DeviseApisFields)
admin.site.register(models.UserProfile)
admin.site.register(models.Farmer)
admin.site.register(models.FarmerStatusHistory)
admin.site.register(models.PartnerPayment)
admin.site.register(models.PaymentAttachment)